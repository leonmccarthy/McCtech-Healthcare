...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvOrders = findViewById(R.id.listViewODMultiline);
        backButton = findViewById(R.id.buttonODBack);
        ...
        Database db = new Database(this,"mctech_healthcare", null, 1);
